...
class Dimensions {
  ...
  static double height15 = screenHeight / 75.80;

  static double width10 = screenWidth / 48;
  static double width20 = screenWidth / 21.03;
  static double width30 = screenWidth / 16.03;
// font
  static double fontBig = screenHeight / 35;
  static double fontMedium = screenHeight / 45;

  static double fontSmall = screenHeight / 61.01;

  // icon fonts
  static double font16 = screenHeight / 50.07;
